...
def demo_modelt_series_array():
    series_panel_array = LinkedPanelArray("P", np.array([-7.990, 0.000, 0.000], dtype=float))

    panel_s1 = Panel("S1", np.array([2.665, 2.061, 0], dtype=float))
    series_panel_array.add_panel(panel_s1)
    panel_s2 = Panel("S2", np.array([6.522, -0.245, 0], dtype=float))
    series_panel_array.add_panel(panel_s2)
    panel_s3 = Panel("S3", np.array([9.069, -9.282, 0], dtype=float))
    series_panel_array.add_panel(panel_s3)
    panel_s4 = Panel("S4", np.array([7.277, -20.091, 0], dtype=float))
    series_panel_array.add_panel(panel_s4)
    panel_s5 = Panel("S5", np.array([-3.896, -30.431, 0], dtype=float))
    series_panel_array.add_panel(panel_s5)

    arm_length = 5.0
    kc_p_s1 = SideArm3BallKinematicCoupling("P_S1", np.array([0.000, 0.000, 0], dtype=float), np.array([3.878, 0.000, 0], dtype=float), 11.649, arm_length, 1.616)
    series_panel_array.link_panels(kc_p_s1, "P", "S1")
    kc_s1_s2 = SideArm3BallKinematicCoupling("S1_S2", np.array([4.040, 0.155, 0], dtype=float), np.array([8.026, -2.498, 0], dtype=float), 14.431, arm_length, 1.034)
    series_panel_array.link_panels(kc_s1_s2, "S1", "S2")
    kc_s2_s3 = SideArm3BallKinematicCoupling("S2_S3", np.array([5.695, -3.532, 0], dtype=float), np.array([10.485, -14.937, 0], dtype=float), 12.474, arm_length, 1.619)
    series_panel_array.link_panels(kc_s2_s3, "S2", "S3")
    kc_s3_s4 = SideArm3BallKinematicCoupling("S3_S4", np.array([10.782, -15.782, 0], dtype=float), np.array([8.220, -28.530, 0], dtype=float), 16.333, arm_length, 1.034)
    series_panel_array.link_panels(kc_s3_s4, "S3", "S4")
    kc_s4_s5 = SideArm3BallKinematicCoupling("S4_S5", np.array([2.125, -24.193, 0], dtype=float), np.array([-9.825, -36.397, 0], dtype=float), 14.749, arm_length, 1.606, 0, np.pi/2, "right")
...
def demo_modelt_montecarloset_array():
    panel_collection_array = LinkedPanelArray("P", np.array([-7.990, 0.000, 0.000], dtype=float))
    ...
    panel_s1m = Panel("S1-", np.array([-6.778, 10.935, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s1m)
    panel_s2m = Panel("S2-", np.array([-3.392, 13.891, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s2m)
    panel_s3m = Panel("S3-", np.array([5.989, 13.521, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s3m)
    panel_s4m = Panel("S4-", np.array([15.716, 8.476, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s4m)
    panel_s5m = Panel("S5-", np.array([22.096, -5.345, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s5m)

    panel_s1p = Panel("S1+", np.array([-2.857, -9.661, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s1p)
    panel_s2p = Panel("S2+", np.array([-3.859, -14.043, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s2p)
    panel_s3p = Panel("S3+", np.array([-11.666, -19.257, 0.000], dtype=float))
    panel_collection_array.add_panel(panel_s3p)

    arm_length = 5.0
    kc_p_s1m = SideArm3BallKinematicCoupling("P_S1-", np.array([-5.641, 7.764, 0], dtype=float), np.array([-4.443, 11.452, 0], dtype=float), 11.649, arm_length, 1.616)
    panel_collection_array.link_panels(kc_p_s1m, "P", "S1-")
    kc_s1m_s2m = SideArm3BallKinematicCoupling("S1-_S2-", np.array([-4.539, 11.654, 0], dtype=float), np.array([-0.785, 14.625, 0], dtype=float), 14.431, arm_length, 1.034)
    panel_collection_array.link_panels(kc_s1m_s2m, "S1-", "S2-")
    kc_s2m_s3m = SideArm3BallKinematicCoupling("S2-_S3-", np.array([-0.522, 12.089, 0], dtype=float), np.array([11.805, 13.120, 0], dtype=float), 12.474, arm_length, 1.619)
    panel_collection_array.link_panels(kc_s2m_s3m, "S2-", "S3-")
    kc_s3m_s4m = SideArm3BallKinematicCoupling("S3-_S4-", np.array([11.999, 13.370, 0], dtype=float), np.array([24.033, 6.766, 0], dtype=float), 16.333, arm_length, 1.034)
    panel_collection_array.link_panels(kc_s3m_s4m, "S3-", "S4-")
    kc_s4m_s5m = SideArm3BallKinematicCoupling("S4-_S5-", np.array([18.027, 2.319, 0], dtype=float), np.array([25.938, -12.828, 0], dtype=float), 14.749, arm_length, 1.606, 0, np.pi/2, "right")
    ...
    kc_s3_s5m = SideArm3BallKinematicCoupling("S3_S5-", np.array([15.178, -8.807, 0], dtype=float), np.array([29.165, -2.119, 0], dtype=float), 17.094, arm_length, 1.536, 0, np.pi/2, "right")
    ...
    kc_p_s1p = SideArm3BallKinematicCoupling("P_S1+", np.array([-5.641, -7.764, 0], dtype=float), np.array([-4.442, -11.452, 0], dtype=float), 11.649, arm_length, 1.616)
    panel_collection_array.link_panels(kc_p_s1p, "P", "S1+")
    kc_s1p_s2p = SideArm3BallKinematicCoupling("S1+_S2+", np.array([-4.246, -11.559, 0], dtype=float), np.array([-5.537, -16.169, 0], dtype=float), 14.431, arm_length, 1.034)
    panel_collection_array.link_panels(kc_s1p_s2p, "S1+", "S2+")
    kc_s2p_s3p = SideArm3BallKinematicCoupling("S2+_S3+", np.array([-7.240, -14.272, 0], dtype=float), np.array([-16.607, -22.352, 0], dtype=float), 12.474, arm_length, 1.619)
    panel_collection_array.link_panels(kc_s2p_s3p, "S2+", "S3+")
    kc_s3p_s5 = SideArm3BallKinematicCoupling("S3+_S5", np.array([-9.326, -24.920, 0], dtype=float), np.array([1.356, -36.157, 0], dtype=float), 17.094, arm_length, 1.536, 0, np.pi/2, "right")
